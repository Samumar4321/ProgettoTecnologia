...
public class Seriale extends Thread{
    ...
    public void run() {
        ...
        while(true){
            ...
            umidita = Integer.parseInt(splittedString[0]);
            luminosita = Integer.parseInt(splittedString[1]);
            temperatura = Integer.parseInt(splittedString[2]);
